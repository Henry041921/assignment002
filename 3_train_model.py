...
class KNN_From_Scratch:
    ...
    def _predict_single(self, row):
        ...
        # Sort by distance to find the nearest ones
...
def plot_model_comparison(cv_scores, test_scores):
    ...
    print(f"Comparison plot saved as: model_comparison_barchart.png")
...
if __name__ == "__main__":
    ...
    print()
    print("Supervised Learning Optimization & Evaluation")
    print()
    ...
    cv_results['KNN'] = best_knn_score
    test_results['KNN'] = knn_acc
